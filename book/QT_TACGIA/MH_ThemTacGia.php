...
<form name="frmThemmoitacgia" method="post" action="MH_ThemTacGia.php" onSubmit="return frmThemmoitacgia_onSubmit()">
  ...
  <table width="600" height="164">
    ...
    <tr>
      <td>Tên tác giả </td>
      <td><input name="txttentacgia" type="text" id="txttentacgia" size="40"></td>
    </tr>
    <tr>
    ...
    <tr>
      <td>Điện thoại </td>
      <td><input name="txtdienthoai" type="text" id="txtdienthoai" maxlength="15"></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td><input name="bntthemtacgia" type="submit" id="bntthemtacgia" value="Thêm" >
